  ...
  return (
    <div className="border-0 bg-neutral-200 dark:bg-neutral-800 shadow-md rounded-2xl p-4 transition-all hover:shadow-lg">
      ...
      {article.categoryName && (
        ...
        <h3 className="text-lg font-semibold text-foreground leading-tight  h-12">
        ...
        <div className="flex flex-wrap gap-4 items-center text-sm text-foreground rounded-lg p-2  h-12">
