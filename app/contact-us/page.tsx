        ...
        <div className="mx-auto mt-2 grid items-center lg:grid-cols-2 gap-6 lg:gap-16 max-w-7xl w-full">
          ...
          >
            <motion.div className="flex gap-x-7 py-6" variants={infoItem}>
              ...
              <div className="grow">
                <h3 className="font-semibold text-neutral-600">Recursos en línea</h3>
                <p className="mt-1 text-sm text-gray-500 dark:text-neutral-500">
                  Encuentra artículos, tutoriales y guías para mejorar tus habilidades.
                </p>
                <a
                  className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-400 hover:text-gray-100 dark:text-neutral-400 dark:hover:text- neutral-200 dark:neutral-800"
                  href="#"
                >
                  Explora el blog
                </a>
            ...
            <motion.div className="flex gap-x-7 py-6" variants={infoItem}>
              ...
              <div className="grow">
                <h3 className="font-semibold text-neutral-600">Soporte por Email</h3>
                <p className="mt-1 text-sm text-gray-500 dark:text-neutral-500">
            ...
            <motion.div className="flex gap-x-7 py-6" variants={infoItem}>
              ...
              <div className="grow">
                <h3 className="font-semibold text-neutral-600">Preguntas Frecuentes</h3>
                <p className="mt-1 text-sm text-gray-500 dark:text-neutral-500">
